"""Unit tests for Cerebras v2 handlers.

These tests verify handler behavior without requiring API keys by using mock responses.
Cerebras handlers inherit from OpenAI handlers since Cerebras uses an OpenAI-compatible API.
"""
...
class MockResponse:
    """Mock Cerebras response for testing (OpenAI-compatible format)."""
...
# ============================================================================
# CerebrasToolsHandler Tests
# ============================================================================


class TestCerebrasToolsHandler:
    """Tests for CerebrasToolsHandler."""

    @pytest.fixture
    def handler(self):
        """Get the TOOLS handler from registry."""
        handlers = mode_registry.get_handlers(Provider.CEREBRAS, Mode.TOOLS)
        return handlers
...
# ============================================================================
# CerebrasMDJSONHandler Tests
# ============================================================================


class TestCerebrasMDJSONHandler:
    """Tests for CerebrasMDJSONHandler."""

    @pytest.fixture
    def handler(self):
        """Get the MD_JSON handler from registry."""
        handlers = mode_registry.get_handlers(Provider.CEREBRAS, Mode.MD_JSON)
        return handlers
...
class TestCerebrasHandlerRegistration:
    """Tests for Cerebras handler registration in the v2 registry."""
    ...
    def test_mode_is_registered(self, mode: Mode):
        """Test all Cerebras modes are registered."""
        assert mode_registry.is_registered(Provider.CEREBRAS, mode)
    ...
    def test_handlers_have_all_methods(self, mode: Mode):
        ...
        handlers = mode_registry.get_handlers(Provider.CEREBRAS, mode)
    ...
    def test_parallel_tools_not_supported(self):
        """Test PARALLEL_TOOLS mode is NOT supported by Cerebras."""
...
class TestCerebrasHandlerEdgeCases:
